  ...
  return (
    ...
    >
      <div className="flex justify-center min-h-[70svh] items-end relative ">
        ...
        <div className="absolute inset-0 flex justify-center">
          <div className="relative w-[50%] h-[20%] ">
            <span
              ...
              style={{ animationDelay: ".2s", clipPath: "polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)" }}
            ></span>
            <span
              className="starEl animate-spinStar w-[4px] h-[4px] absolute top-[60%]  left-[30%] bg-[--c8] p-1 "
              style={{ animationDelay: ".3s", clipPath: "polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)" }}
            ></span>
            <span
              className="starEl animate-spinStar w-[4px] h-[4px] absolute -top-[8%] left-[85%] bg-[--c8] p-1 "
              style={{ animationDelay: ".28s", clipPath: "polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)" }}
            ></span>
            <span
        ...
        <div className="moonEl h-12 w-12 bg-[--c7] absolute top-2 rounded-full animate-moon flex">
        ...
        <span
          ...
          style={{ clipPath: "polygon(45% 78%, 36% 80%, 28% 81%, 20% 78%, 14% 75%, 7% 69%, 1% 55%, 1% 48%, 1% 41%, 5% 29%, 13% 23%, 22% 20%, 30% 19%, 40% 19%, 93% 33%, 98% 43%, 100% 50%, 98% 56%, 93% 66%)" }}
        ></span>
        <span
          className="rocketEl rounded-full w-4 h-[10px] bg-[--c5] absolute top-[10px] right-[-20%] blur-[6px]  animate-comet"
          style={{ animationDelay: ".02s", clipPath: "polygon(45% 78%, 36% 80%, 28% 81%, 20% 78%, 14% 75%, 7% 69%, 1% 55%, 1% 48%, 1% 41%, 5% 29%, 13% 23%, 22% 20%, 30% 19%, 40% 19%, 93% 33%, 98% 43%, 100% 50%, 98% 56%, 93% 66%)" }}
        ></span>
        <span
          className="rocketEl rounded-full w-4 h-[10px] bg-[--c5] absolute top-[10px] right-[-20%] blur-[12px] animate-comet "
          style={{ animationDelay: ".04s", clipPath: "polygon(45% 78%, 36% 80%, 28% 81%, 20% 78%, 14% 75%, 7% 69%, 1% 55%, 1% 48%, 1% 41%, 5% 29%, 13% 23%, 22% 20%, 30% 19%, 40% 19%, 93% 33%, 98% 43%, 100% 50%, 98% 56%, 93% 66%)" }}
        ></span>
        <span
          className="rocketEl rounded-full w-4 h-[10px] bg-[--c5] absolute top-[10px] right-[-20%] blur-[18px] animate-comet "
          style={{ animationDelay: ".06s", clipPath: "polygon(45% 78%, 36% 80%, 28% 81%, 20% 78%, 14% 75%, 7% 69%, 1% 55%, 1% 48%, 1% 41%, 5% 29%, 13% 23%, 22% 20%, 30% 19%, 40% 19%, 93% 33%, 98% 43%, 100% 50%, 98% 56%, 93% 66%)" }}
        ></span>

        <div className="flex flex-col mx-2 p-4 max-[900px]:max-w-[400px] max-[900px]:mx-auto z-50">
          <p className="text-5xl max-[500px]:text-[12vw] font-bold tracking-widest animate-fadeUPX">Hi! I&apos;m Mihai</p>
          <p
      ...
      <div className="flex justify-center gap-[5vw] mx-[5vw] my-[25vh] max-[934px]:items-center max-[934px]:flex-col">
        ...
        <div className="basis-[40%] mx-2">
          ...
          <p>An enthusiast of drone videography and bike riding, I have a self-taught skill set in video editing and post-production.</p>
        </div>
      </div>
      ...
      >
        <div className="basis-[40%] mx-2 text-right">
          ...
          >
            <p className="text-3xl font-black">Want to say hi?</p>
