    ...
    <div ref={ref} className="mainContent">
      <div className="flex justify-center gap-[5vw] mx-[5vw] my-[25vh] max-[900px]:flex-col">
        <div className="flex flex-col basis-[40%] mx-2 p-4 max-[900px]:max-w-[400px] max-[900px]:mx-auto">
          <p className="text-5xl max-[500px]:text-[12vw] font-bold tracking-widest animate-fadeUPX">WELCOME!</p>
          <p className="animate-fadeUPX" style={{ animationDuration: `1s` }}>
            Hello and nice to have you here! I'm Mihai and a passionate Web Developer.
          </p>
          <div className="inline-flex gap-4 w-100 my-2">
            <a href="https://www.linkedin.com/in/mihai-culea-614747227/" target="_blank">
          ...
          <a href="../../assets/CV Mihai Culea.docx" download className=" px-6 py-2 bg-[--accentcolor] rounded-xl my-2 flex justify-between  animate-fadeUPX" style={{ animationDuration: `1.9s` }}>
        ...
        <div className="basis-[40%] mx-2  max-[900px]:max-w-[400px]  max-[900px]:mx-auto">
          <picture>
            <img src="../../assets/1.jpg" alt="" className="animate-scaleFromMax" />
          </picture>
        </div>
      </div>

      <div className="flex gap-3 mx-[5vw] flex-wrap justify-center my-[25vh] font-[bold] items-baseline animate-fadeUPX" style={{ animationDuration: `2.2s` }}>
        <span className="tracking-[10px] text-[--accentcolor] font-black text-xl my-auto">Tech Stack</span>
        <span className="font-bol my-auto font-black text-3xl translate-y-[-4px]">|</span>
      ...
      <div className="flex justify-center gap-[5vw] mx-[5vw] my-[25vh] max-[934px]:items-center max-[934px]:flex-col">
        ...
        <div className="basis-[40%] mx-2">
          ...
          <p>An enthusiast of drone videography and bike riding, I have a self-taught skill set in video editing and post-production. I stay informed about the latest trends and technologies in the field by actively engaging with communities related to drones and videography.</p>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center items-center gap-[5vw] mx-[5vw] mt-[25vh]">
        <div className="basis-[40%] mx-2">
          <p className="text-[--accentcolor] font-black tracking-[10px] text-center">PROJECTS</p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-2">
        {fromDB.map(
          (project, i) =>
            i < 3 && (
              <div key={crypto.randomUUID()} className="mx-2 w-[250px] relative my-2">
                <div className="relative ">
                  <div className="absolute inset-0 bg-black opacity-25"></div>
                  <picture>
                    <img src={project.img} width="250" height="250" className="mx-auto block object-cover hover:opacity-50 rounded" />
                  </picture>
                  <a href={project.link} target="_blank" className="absolute inset-0 z-10 flex justify-center items-center opacity-0 hover:opacity-100 bg-[#dba511a3] transition duration-300 ease-out">
                ...
                <div className="tags flex gap-2 flex-wrap my-2">
                  {project.tags.map((tag) => (
                    <span key={crypto.randomUUID()} className={`${tag.class} ${tag.el == "VanillaJS" ? "text-[20px]" : ""}`}>
                      {tag.el}
                    </span>
                  ))}
                </div>
      ...
      <div className="flex flex-col items-center justify-center gap-[5vw] mx-[5vw] my-[25vh]">
        <p className="text-[--accentcolor] font-black tracking-[6px]">PORTFOLIO</p>
