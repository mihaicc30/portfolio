...
const Projects = ({ fromDB }) => {
  ...
  return (
    <div className='mainContent'>
      <p className='text-[--accentcolor] font-black tracking-[10px] text-center mt-[25vh] mb-5'>PROJECTS</p>

      <div className='flex flex-wrap justify-center gap-2 mb-[25vh]'>
        {fromDB.map((project, i) => (
          <div
            key={crypto.randomUUID()}
            className={`flex flex-col rounded mx-2 w-[250px] h-[100%] min-h-[464px] relative my-2 animate-fadeUP2 border-2 border-[#74747424]`}
            ...
            <p className='font-bold tracking-[4px] my-2 px-2 text-ellipsis line-clamp-1 overflow-hidden'>
              {project.name}
            </p>
            ...
            {project.info && (
              <div className='tags flex gap-2 flex-wrap mt-auto p-2'>
