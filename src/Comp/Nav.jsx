...
const Nav = () => {
  ...
  const handleToggle = () => {
    ...
    document.body.style.backgroundColor = darkMode ? 'var(--lightthemecolor)' : 'var(--darkthemecolor)'
    document.body.style.color = darkMode ? 'var(--darkthemecolor)' : 'var(--lightthemecolor)'
  }
    ...
    <div className='flex list-none justify-between mt-5 p-3 mx-4 animate-fadeDOWN relative'>
      ...
      <ul className='flex gap-5 p-3 '>
        <button
          ...
          <div
            ref={ref}
            className={`flex fixed flex-col w-[100%] right-[150%] bg-[--lightthemecolor] rounded-r-[50px] z-[50] transition-[2s] ease-[cubic-bezier(0.95,0.05,0.795,0.035)] text-2xl gap-8 pr-8 py-[100px] border-2 border-black text-[--darkthemecolor] cursor-default `}>
            <span
              className={`cursor-pointer transition-[2s] ease bg-[--accentcolor] rounded-r-xl tracking-widest text-end px-8 shadow-[0px_4px_2px_#a5a5a5e3]`}
              onClick={e => {
                e.preventDefault()
            ...
            <span
              className={`cursor-pointer transition-[2s] ease bg-[--accentcolor] tracking-widest rounded-r-xl text-end px-8 shadow-[0px_4px_2px_#a5a5a5e3]`}
              onClick={e => {
                e.preventDefault()
        ...
        {/* <button onClick={handleToggle} className=" animate-fadeDOWN2" style={{ animationDuration: `2500ms` }}>
          <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" width={24} height={24} stroke="#000" viewBox="0 0 512.00 512.00">
            <path
